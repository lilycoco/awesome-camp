...
export const scheduleList = [
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        必要に応じて開催場所や、お食事、楽しいフォトバスやポートレートマシーンといったゲストの皆さまと一緒に楽しめるコンテンツなどのご紹介もさせていただいております。（紹介料無料）
        <br />
  ...
  },
  {
    ...
    description: (
      <div>
        場所と日程の確定後、必要品目の手配に入ります。
        <br />
        テントやタープ以外の項目についてのご利用は自由です。必要に応じてご依頼ください。
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        パーティの後、お客様によってはアフターパーティーでお泊りになるゲストの皆さまと焚火をしながら余韻を楽しまれる方もいらっしゃいます。
